...
## License
The Laravel framework is open-sourced software licensed under the [MIT license](https://opensource.org/licenses/MIT)."# pharmacy_medicine_management" 
# pharmacy_medicine_management
